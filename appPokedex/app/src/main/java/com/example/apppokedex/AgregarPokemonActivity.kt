...
class AgregarPokemonActivity : AppCompatActivity() {
    ...
    fun onSavePokemonClick(view: View) {
        // Obtener el número de la Pokédex como texto y convertirlo a entero
        val numPokedex = editTextNumPokedex.text.toString().toIntOrNull() ?: 0 // Si no es válido, asigna 0
        ...
        val nuevoPokemon = Pokemon(
            ...
            num_pokedex = numPokedex, // Ahora es un Int
